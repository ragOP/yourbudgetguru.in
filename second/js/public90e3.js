...
! function ($, options) {
    ...
    var Utils = function (options) {
        ...
        function getDomain(url) {
            ...
            if (url.indexOf('https://productivitygenie.in/') !== -1) {
                return url.split('https://productivitygenie.in/')[0];
            }
        ...
        return {
            ...
            getLinkExtension: function (link) {
                ...
                link = link.substring(0, (link.indexOf("?") === -1) ? link.length : link.indexOf("?"));
                link = link.substring(link.lastIndexOf("https://productivitygenie.in/") + 1, link.length);
